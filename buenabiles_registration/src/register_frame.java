...
public void insert(){
   ...
   if(!"".equals(fn)&&!"".equals(ln)&&!"".equals(user)&&!"".equals(pass)&&!"".equals(cpass)){
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(567, 470));
        ...
        cpsw.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        psw.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        usr.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        lnm.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        fnm.setCaretColor(new java.awt.Color(255, 255, 255));
        fnm.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel6.setFont(new java.awt.Font("Goudy Old Style", 1, 34)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 204, 0));
        jLabel6.setText("FOR REGISTRATION");
